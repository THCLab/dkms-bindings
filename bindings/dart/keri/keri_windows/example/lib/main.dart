              ...
              children: [
                RawMaterialButton(
                    onPressed: () async {
                      ...
                      vec2.add(await KeriPlatformInterface.instance.newPublicKey(
                ...
                currentKey.isNotEmpty
                    ? RawMaterialButton(
                    onPressed: () async {
                      icpEvent = await KeriPlatformInterface.instance.incept(
                          publicKeys: vec1!,
                          nextPubKeys: vec2,
                          witnesses: vec3,
                          witnessThreshold: 0);
                ...
                signature.isNotEmpty
                    ? RawMaterialButton(
                    onPressed: () async {
                      controller = await KeriPlatformInterface.instance.finalizeInception(
                          event: icpEvent,
                ...
                controllerId.isNotEmpty
                    ...
                    onPressed: () async {
                      ...
                      currentKeys.add(await KeriPlatformInterface.instance.newPublicKey(
                          kt: KeyType.Ed25519, keyB64: currentKey));
                      newNextKeys.add(await KeriPlatformInterface.instance.newPublicKey(
                          kt: KeyType.Ed25519, keyB64: nextKey));
                      rotationEvent = await KeriPlatformInterface.instance.rotate(
                ...
                signature2.isNotEmpty
                    ? RawMaterialButton(
                    onPressed: () async {
                      finalizedEvent = await KeriPlatformInterface.instance.finalizeEvent(
                ...
                finalizedEvent
                    ? RawMaterialButton(
                    onPressed: () async {
                      anchorEvent = await KeriPlatformInterface.instance.anchor(
                          controller: controller,
                          data: dataForAnchor,
                ...
                signature3.isNotEmpty
                    ? RawMaterialButton(
                    onPressed: () async {
                      finalizedAnchor = await KeriPlatformInterface.instance.finalizeEvent(
                          identifier: controller,
                          event: anchorEvent,
                          signature: await KeriPlatformInterface.instance.signatureFromHex(
                              st: SignatureType.Ed25519Sha512,
