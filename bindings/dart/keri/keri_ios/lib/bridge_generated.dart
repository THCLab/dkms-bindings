...
part 'bridge_generated.freezed.dart';
        ...
        abstract class KeriDart {
            Future<PublicKey> newPublicKey({ required KeyType kt,required String keyB64,dynamic hint });
...
Future<List<ActionRequired>> finalizeMailboxQuery({ required Identifier identifier,required String queryEvent,required Signature signature,dynamic hint });
...
var arg1 = _platform.api2wire_String(keyB64);
...
var arg2 = _platform.api2wire_box_autoadd_signature(signature);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_finalize_mailbox_query(port_, arg0, arg1, arg2),
        ...
        FlutterRustBridgeTaskConstMeta get kFinalizeMailboxQueryConstMeta => const FlutterRustBridgeTaskConstMeta(
