...
part 'bridge_generated.freezed.dart';
        ...
        abstract class KeriDart {
            Future<PublicKey> newPublicKey({ required KeyType kt,required String keyB64UrlSafe,dynamic hint });

FlutterRustBridgeTaskConstMeta get kNewPublicKeyConstMeta;

Future<Signature> signatureFromHex({ required SignatureType st,required String signature,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSignatureFromHexConstMeta;

Future<Signature> signatureFromB64({ required SignatureType st,required String signature,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSignatureFromB64ConstMeta;

Future<Config> withInitialOobis({ required Config config,required String oobisJson,dynamic hint });
...
Future<bool> initKel({ required String inputAppDir,Config? optionalConfigs,dynamic hint });

FlutterRustBridgeTaskConstMeta get kInitKelConstMeta;

Future<String> incept({ required List<PublicKey> publicKeys,required List<PublicKey> nextPubKeys,required List<String> witnesses,required int witnessThreshold,dynamic hint });

FlutterRustBridgeTaskConstMeta get kInceptConstMeta;

Future<Identifier> finalizeInception({ required String event,required Signature signature,dynamic hint });

FlutterRustBridgeTaskConstMeta get kFinalizeInceptionConstMeta;

Future<String> rotate({ required Identifier identifier,required List<PublicKey> currentKeys,required List<PublicKey> newNextKeys,required List<String> witnessToAdd,required List<String> witnessToRemove,required int witnessThreshold,dynamic hint });

FlutterRustBridgeTaskConstMeta get kRotateConstMeta;

Future<String> anchor({ required Identifier identifier,required String data,required DigestType algo,dynamic hint });

FlutterRustBridgeTaskConstMeta get kAnchorConstMeta;

Future<String> anchorDigest({ required Identifier identifier,required List<String> sais,dynamic hint });

FlutterRustBridgeTaskConstMeta get kAnchorDigestConstMeta;

Future<String> addWatcher({ required Identifier identifier,required String watcherOobi,dynamic hint });

FlutterRustBridgeTaskConstMeta get kAddWatcherConstMeta;

Future<bool> sendOobiToWatcher({ required Identifier identifier,required String oobisJson,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSendOobiToWatcherConstMeta;

Future<bool> finalizeEvent({ required Identifier identifier,required String event,required Signature signature,dynamic hint });
...
Future<bool> broadcastReceipts({ required Identifier identifier,required List<Identifier> witnessList,dynamic hint });

FlutterRustBridgeTaskConstMeta get kBroadcastReceiptsConstMeta;

Future<GroupInception> inceptGroup({ required Identifier identifier,required List<Identifier> participants,required int signatureThreshold,required List<String> initialWitnesses,required int witnessThreshold,dynamic hint });

FlutterRustBridgeTaskConstMeta get kInceptGroupConstMeta;

Future<Identifier> finalizeGroupIncept({ required Identifier identifier,required String groupEvent,required Signature signature,required List<DataAndSignature> toForward,dynamic hint });

FlutterRustBridgeTaskConstMeta get kFinalizeGroupInceptConstMeta;

Future<List<String>> queryMailbox({ required Identifier whoAsk,required Identifier aboutWho,required List<String> witness,dynamic hint });

FlutterRustBridgeTaskConstMeta get kQueryMailboxConstMeta;

Future<List<String>> queryWatchers({ required Identifier whoAsk,required Identifier aboutWho,dynamic hint });

FlutterRustBridgeTaskConstMeta get kQueryWatchersConstMeta;

Future<List<ActionRequired>> finalizeQuery({ required Identifier identifier,required String queryEvent,required Signature signature,dynamic hint });
...
Future<List<PublicKeySignaturePair>> getCurrentPublicKey({ required String attachment,dynamic hint });

FlutterRustBridgeTaskConstMeta get kGetCurrentPublicKeyConstMeta;

Future<Identifier> newFromStrStaticMethodIdentifier({ required String idStr,dynamic hint });

FlutterRustBridgeTaskConstMeta get kNewFromStrStaticMethodIdentifierConstMeta;

Future<String> toStrMethodIdentifier({ required Identifier that,dynamic hint });

FlutterRustBridgeTaskConstMeta get kToStrMethodIdentifierConstMeta;

Future<DataAndSignature> newStaticMethodDataAndSignature({ required String data,required Signature signature,dynamic hint });
...
final String additionaData;
                ...
                ActionRequired({required this.action,required this.data,required this.additionaData,});
...
class Config {
                ...
                Config({required this.initialOobis,});
...
final Signature signature;
                ...
                DataAndSignature({required this.bridge,required this.data,required this.signature,});

                static Future<DataAndSignature> newDataAndSignature({ required KeriDart bridge,required String data,required Signature signature,dynamic hint })=>bridge.newStaticMethodDataAndSignature(data:data,signature:signature,hint: hint);
...
const factory DigestType.blake2B256(Uint8List field0,) = DigestType_Blake2B256;
const factory DigestType.blake2S256(Uint8List field0,) = DigestType_Blake2S256;
                }
...
final List<String> exchanges;
                ...
                GroupInception({required this.icpEvent,required this.exchanges,});
...
final String id;
                ...
                Identifier({required this.bridge,required this.id,});

                static Future<Identifier> newFromStr({ required KeriDart bridge,required String idStr,dynamic hint })=>bridge.newFromStrStaticMethodIdentifier(idStr:idStr,hint: hint);

 Future<String> toStr({ dynamic hint })=>bridge.toStrMethodIdentifier(that: this, );
...
final Uint8List publicKey;
                ...
                PublicKey({required this.derivation,required this.publicKey,});
...
final Signature signature;
                ...
                PublicKeySignaturePair({required this.key,required this.signature,});
...
final Uint8List signature;
                ...
                Signature({required this.derivation,required this.signature,});
...
class KeriDartImpl implements KeriDart {
                ...
                factory KeriDartImpl(ExternalLibrary dylib) => KeriDartImpl.raw(KeriDartPlatform(dylib));
...
var arg1 = _platform.api2wire_String(keyB64UrlSafe);
            ...
            callFfi: (port_) => _platform.inner.wire_new_public_key(port_, arg0, arg1),
        ...
        FlutterRustBridgeTaskConstMeta get kNewPublicKeyConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(signature);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_signature_from_hex(port_, arg0, arg1),
        ...
        FlutterRustBridgeTaskConstMeta get kSignatureFromHexConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(signature);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_signature_from_b64(port_, arg0, arg1),
            parseSuccessData: _wire2api_signature,
        ...
        FlutterRustBridgeTaskConstMeta get kSignatureFromB64ConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(oobisJson);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_with_initial_oobis(port_, arg0, arg1),
        ...
        FlutterRustBridgeTaskConstMeta get kWithInitialOobisConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> changeController({ required String dbPath,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kChangeControllerConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_opt_box_autoadd_config(optionalConfigs);
        ...
        FlutterRustBridgeTaskConstMeta get kInitKelConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "init_kel",
...
var arg3 = _platform.api2wire_u64(witnessThreshold);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_incept(port_, arg0, arg1, arg2, arg3),
        ...
        FlutterRustBridgeTaskConstMeta get kInceptConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "incept",
            argNames: ["publicKeys", "nextPubKeys", "witnesses", "witnessThreshold"],
        );
...
var arg1 = _platform.api2wire_box_autoadd_signature(signature);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_finalize_inception(port_, arg0, arg1),
        ...
        FlutterRustBridgeTaskConstMeta get kFinalizeInceptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg5 = _platform.api2wire_u64(witnessThreshold);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_rotate(port_, arg0, arg1, arg2, arg3, arg4, arg5),
            parseSuccessData: _wire2api_String,
            
        constMeta: kRotateConstMeta,
        argValues: [identifier, currentKeys, newNextKeys, witnessToAdd, witnessToRemove, witnessThreshold],
        hint: hint,
        
        ));}


        FlutterRustBridgeTaskConstMeta get kRotateConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "rotate",
            argNames: ["identifier", "currentKeys", "newNextKeys", "witnessToAdd", "witnessToRemove", "witnessThreshold"],
        );
...
var arg2 = _platform.api2wire_box_autoadd_digest_type(algo);
        ...
        FlutterRustBridgeTaskConstMeta get kAnchorConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "anchor",
...
var arg1 = _platform.api2wire_StringList(sais);
        ...
        FlutterRustBridgeTaskConstMeta get kAnchorDigestConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(watcherOobi);
        ...
        FlutterRustBridgeTaskConstMeta get kAddWatcherConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(oobisJson);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_send_oobi_to_watcher(port_, arg0, arg1),
            parseSuccessData: _wire2api_bool,
        ...
        FlutterRustBridgeTaskConstMeta get kSendOobiToWatcherConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_box_autoadd_signature(signature);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_finalize_event(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_bool,
        ...
        FlutterRustBridgeTaskConstMeta get kFinalizeEventConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> notifyWitnesses({ required Identifier identifier,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kNotifyWitnessesConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_list_identifier(witnessList);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_broadcast_receipts(port_, arg0, arg1),
            parseSuccessData: _wire2api_bool,
        ...
        FlutterRustBridgeTaskConstMeta get kBroadcastReceiptsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg4 = _platform.api2wire_u64(witnessThreshold);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_incept_group(port_, arg0, arg1, arg2, arg3, arg4),
            parseSuccessData: _wire2api_group_inception,
            
        constMeta: kInceptGroupConstMeta,
        argValues: [identifier, participants, signatureThreshold, initialWitnesses, witnessThreshold],
        hint: hint,
        
        ));}


        FlutterRustBridgeTaskConstMeta get kInceptGroupConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "incept_group",
            argNames: ["identifier", "participants", "signatureThreshold", "initialWitnesses", "witnessThreshold"],
        );
...
var arg3 = _platform.api2wire_list_data_and_signature(toForward);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_finalize_group_incept(port_, arg0, arg1, arg2, arg3),
            parseSuccessData: (d) => _wire2api_identifier(d),
        ...
        FlutterRustBridgeTaskConstMeta get kFinalizeGroupInceptConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_StringList(witness);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_query_mailbox(port_, arg0, arg1, arg2),
        ...
        FlutterRustBridgeTaskConstMeta get kQueryMailboxConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_box_autoadd_identifier(aboutWho);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_query_watchers(port_, arg0, arg1),
            parseSuccessData: _wire2api_StringList,
        ...
        FlutterRustBridgeTaskConstMeta get kQueryWatchersConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_box_autoadd_signature(signature);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_finalize_query(port_, arg0, arg1, arg2),
        ...
        FlutterRustBridgeTaskConstMeta get kFinalizeQueryConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> resolveOobi({ required String oobiJson,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kResolveOobiConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> processStream({ required String stream,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kProcessStreamConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> getKel({ required Identifier identifier,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kGetKelConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "get_kel",
            argNames: ["identifier"],
        );
...
Future<List<PublicKeySignaturePair>> getCurrentPublicKey({ required String attachment,dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_get_current_public_key(port_, arg0),
        ...
        FlutterRustBridgeTaskConstMeta get kGetCurrentPublicKeyConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<Identifier> newFromStrStaticMethodIdentifier({ required String idStr,dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_new_from_str__static_method__Identifier(port_, arg0),
            parseSuccessData: (d) => _wire2api_identifier(d),
        ...
        FlutterRustBridgeTaskConstMeta get kNewFromStrStaticMethodIdentifierConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> toStrMethodIdentifier({ required Identifier that,dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_to_str__method__Identifier(port_, arg0),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kToStrMethodIdentifierConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_box_autoadd_signature(signature);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_new__static_method__DataAndSignature(port_, arg0, arg1),
        ...
        FlutterRustBridgeTaskConstMeta get kNewStaticMethodDataAndSignatureConstMeta => const FlutterRustBridgeTaskConstMeta(
...
ActionRequired _wire2api_action_required(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return ActionRequired(action: _wire2api_action(arr[0]),
...
Config _wire2api_config(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return Config(initialOobis: _wire2api_String(arr[0]),);
        }
...
DataAndSignature _wire2api_data_and_signature(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return DataAndSignature(bridge: this,
...
GroupInception _wire2api_group_inception(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return GroupInception(icpEvent: _wire2api_String(arr[0]),
...
List<PublicKeySignaturePair> _wire2api_list_public_key_signature_pair(dynamic raw) {
            return (raw as List<dynamic>).map(_wire2api_public_key_signature_pair).toList();
        }
...
PublicKey _wire2api_public_key(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return PublicKey(derivation: _wire2api_key_type(arr[0]),
...
PublicKeySignaturePair _wire2api_public_key_signature_pair(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return PublicKeySignaturePair(key: _wire2api_public_key(arr[0]),
...
Signature _wire2api_signature(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return Signature(derivation: _wire2api_signature_type(arr[0]),
...
@protected
                    ffi.Pointer<wire_DigestType> api2wire_box_autoadd_digest_type(DigestType raw) {
...
@protected
                    ffi.Pointer<wire_list_data_and_signature> api2wire_list_data_and_signature(List<DataAndSignature> raw) {
...
@protected
                    ffi.Pointer<wire_list_identifier> api2wire_list_identifier(List<Identifier> raw) {
...
void _api_fill_to_wire_box_autoadd_digest_type(DigestType apiObj, ffi.Pointer<wire_DigestType> wireObj) {
                _api_fill_to_wire_digest_type(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_identifier(Identifier apiObj, ffi.Pointer<wire_Identifier> wireObj) {
                _api_fill_to_wire_identifier(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_signature(Signature apiObj, ffi.Pointer<wire_Signature> wireObj) {
                _api_fill_to_wire_signature(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_signature(Signature apiObj, ffi.Pointer<wire_Signature> wireObj) {
                _api_fill_to_wire_signature(apiObj, wireObj.ref);
            }
...
void _api_fill_to_wire_data_and_signature(DataAndSignature apiObj, wire_DataAndSignature wireObj) {
                wireObj.data = api2wire_String(apiObj.data);
wireObj.signature = api2wire_box_signature(apiObj.signature);
            }

void _api_fill_to_wire_digest_type(DigestType apiObj, wire_DigestType wireObj) {
                if (apiObj is DigestType_Blake3_256) { wireObj.tag = 0; return; }
if (apiObj is DigestType_SHA3_256) { wireObj.tag = 1; return; }
if (apiObj is DigestType_SHA2_256) { wireObj.tag = 2; return; }
if (apiObj is DigestType_Blake3_512) { wireObj.tag = 3; return; }
if (apiObj is DigestType_SHA3_512) { wireObj.tag = 4; return; }
if (apiObj is DigestType_Blake2B512) { wireObj.tag = 5; return; }
if (apiObj is DigestType_SHA2_512) { wireObj.tag = 6; return; }
...
void _api_fill_to_wire_identifier(Identifier apiObj, wire_Identifier wireObj) {
